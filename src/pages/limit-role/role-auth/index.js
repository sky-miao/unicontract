  ...
  constructor(props) {
    ...
    const formItemLayout = {
      ...
      wrapperCol: {
		...
		return(
  		<Modal className="role-info-model" title="编辑" visible={show}
        okText="保存"
...
const RoleAuthModal = Form.create()(RoleAuth);
export default connect(mapStateToProps, mapDispatchToProps)(RoleAuthModal)
